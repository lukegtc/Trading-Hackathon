...
class Trader:
    ...
    def _hedge(self):
        ...
        # total volume
        total_positions_abs_volume  = abs(total_positions) # Hedge CLASS: self.volume = abs(self.total_positions) 
        ...
        print(f"selected_price={selected_price} | volume={total_positions} | side={selected_side} | order_type={order_type}")
        self.order_handler.place_order(instrument_id=self.LIQUID_INSTRUMENT, price=selected_price, volume=total_positions, side=selected_side, order_type=order_type)    
        return False